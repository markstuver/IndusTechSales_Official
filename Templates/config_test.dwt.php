...
<?php
	...
	# User
	define('USER_USERNAME','dplank');
	define('USER_PASSWORD','80f97872eb3fb18611fc7eac35312c5e428fb2c9');
	...
	# Administrator
	define('ADMINISTRATOR_USERNAME','mastuver');
	define('ADMINISTRATOR_PASSWORD','27b825ef06363c3b9908dc77504f155105612c25');
	...
	# Paths
	define('SERVER_ADDR','107.180.54.176');
	define('WEBSITE_URL','http://www.industechsales.com/');
	define('ROOT_DIRECTORY','/home/dennisplank/public_html/');
	...
	define('EDITABLE_REGION_TAGS_START','<!-- TemplateBeginEditable name="%s" -->,
	<!-- InstanceBeginEditable name="%s" -->');
	define('EDITABLE_REGION_TAGS_END','<!-- TemplateEndEditable -->,<!-- InstanceEndEditable -->');
	define('DEBUG_MODE','0');
	define('DEMO_MODE','0');
	define('BLOWFISH','fb5f5af6f4a5bcaa32200ebbe7c5b2');
?>